...
const HotspotPackages = () => {
  ...
  const hotspotLocations = ['Metro Place Shopping Center', 'Kutus Old Market', 'Kirinyaga University Hostels', 'Kutus Main Stage', 'Dickie\'s Pub', 'Mzalendo Annex & Pub', 'Kutus Market', 'Sagana Town Center', 'Karatina University Campus', 'Kerugoya Town', 'Kianyaga Shopping Center', 'Baricho Market', 'Kimbimbi Shopping Center', 'Kagio Market', 'Kiamaciri Shopping Center'];
